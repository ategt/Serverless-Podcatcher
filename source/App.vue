<template>
  <div class="inner-app">
    ...
    <div class="regular-issue-panel">
      <div class="regular-issue-panel-spacer">
      </div>
      <div class="issue-list" v-if="podcastErrorsList.length">
    ...
    <div class="add-feed-panel">
      <div class="add-feed-form-spacer"></div>
